...
public class T extends Figura
{
    ...
    public T()
    {
       ...
       coordenadas[3]=new Punto(21+(Dibujo.cl/2)*Dibujo.dm+2*Dibujo.dm,Dibujo.limiteSuperior);
        ...
        switch(estado()){
            case 4:
              if(!esLimite()){
                 ...
                 coordenadas[3].setX(coordenadas[3].getX()-Dibujo.dm*2);  coordenadas[2].setY(coordenadas[2].getY()+Dibujo.dmy);
                } 
            ...
            case 1:
               if(!esLimite()){
                   ...
                   coordenadas[2].setX(coordenadas[2].getX()+Dibujo.dm);  coordenadas[3].setY(coordenadas[3].getY()+Dibujo.dmy*2);
            ...
            case 3 :
               if(!esLimite()){
                   ...
                   coordenadas[1].setX(coordenadas[1].getX()-Dibujo.dm*2);  coordenadas[3].setY(coordenadas[3].getY()-Dibujo.dmy*2);
