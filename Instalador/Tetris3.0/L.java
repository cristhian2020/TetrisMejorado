...
public class L extends Figura
{
    ...
    public L()
    {
       ...
       color= new Color(23,45,112);
       
      coordenadas[0]=new Punto(21+(Dibujo.cl/2)*Dibujo.dm+Dibujo.dm, Dibujo.limiteSuperior+2*Dibujo.dmy);
    ...
    public void rotar(){
     switch(estado()){
       ...
       case 1:
           if(!esLimite()){
          /*posicionX[1]+=60; posicionY[1]+=20;
            posicionX[2]+=40; posicionY[3]-=20;
            posicionX[3]+=20;  */     
